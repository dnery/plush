...
int main (int argc, char **argv)
{
         ...
         * the value it receives as its first argument converted to an integer.
         * If no arguments are given, the program returns the default value
         * T_NOARG.
         */
        ...
        if (val == T_MAKEIO)
        {
                ...
                /*
                 * If a correct watchword was received, send the countersig. If
                 * this point has been reach due to a timeout, though, send a
                 * bad ack.
                 */
